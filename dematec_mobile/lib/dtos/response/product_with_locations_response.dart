import 'dart:convert';
import 'package:dematec_mobile/dtos/response/product_location_response.dart';
import 'package:dematec_mobile/model/product_with_locations_model.dart';

class ProductWithLocationsResponse {
  ...
  final List<ProductLocationResponse> storageBin;

  ProductWithLocationsResponse({
    this.reference,
  ...
  ProductWithLocationsModel toModel() {
    return ProductWithLocationsModel(
      idProduct: idProduct,
      ...
      storageBin: storageBin.map((storageBin) => storageBin.toModel()).toList(),
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'netWeight': netWeight,
      'packQuantity': packQuantity,
      'storageBin': storageBin.map((x) => x.toMap()).toList(),
    };
  }

  factory ProductWithLocationsResponse.fromMap(Map<String, dynamic> map) {
    return ProductWithLocationsResponse(
      ...
      minQuantity: map['minQuantity'] != null
          ? (map['minQuantity'] as num).toDouble()
          : null,
      maxQuantity: map['maxQuantity'] != null
          ? (map['maxQuantity'] as num).toDouble()
          : null,
      ...
      grossWeight: map['grossWeight'] != null
          ? (map['grossWeight'] as num).toDouble()
          : null,
      netWeight: map['netWeight'] != null
          ? (map['netWeight'] as num).toDouble()
          : null,
      packQuantity: map['packQuantity'] != null
          ? (map['packQuantity'] as num).toDouble()
          : null,
      storageBin: map['storageBin'] != null
          ? (map['storageBin'] as List<dynamic>)
                .map(
                  (item) => ProductLocationResponse.fromMap(
  ...
  factory ProductWithLocationsResponse.fromJson(String source) =>
      ProductWithLocationsResponse.fromMap(
